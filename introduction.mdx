...
- **Core Logic Engine** — formula parsing, tautology checking, truth table generation, evaluation tree construction, and educational explanation building, all in `tautoteacher2.core`.
